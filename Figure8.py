...
CDC = 0.0021 #float(input("What is the DC capacitance (in microF)? "))
CINF = 0.00021 # float(input("What is the capacitance at infinity? "))
...
for i in range(3,8):
    ...
    lines = ["k-","k--","k:"]
    plt.plot(XSpace1,II1,lines[0], label = 'Telegrapher - constant capacitance') 
    plt.plot(XSpace1,II2,lines[1], label = 'Telegrapher - variable capacitance') 
    ...
    plt.legend(loc='best')
    plt.savefig("21G0_Low_Cap_Freq="+str(f)+"xf="+str(xf)+"_tf="+str(tf)+".png")
    plt.show()
